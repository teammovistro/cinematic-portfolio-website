...
export function Chrome() {
  ...
  return (
    ...
    >
      {/* top bar */}
      <header className="flex items-center justify-between px-5 py-4 sm:px-8 sm:py-6 md:px-12">
        ...
        <div className="flex items-center gap-3.5 sm:gap-5 md:gap-7">
          <button
            ...
            data-cursor="hover"
            className="pointer-events-auto font-mono text-[0.62rem] sm:text-[0.7rem] uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[color:var(--muted-foreground)] transition-colors hover:text-[color:var(--gold)]"
          >
            About
          </button>
          <button
